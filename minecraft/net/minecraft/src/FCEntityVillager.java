...
//			{
	...
	public static class WeightMerchantEnchantmentEntry extends WeightedMerchantEntry {
		...
		//AARON modifies the generateRecipe method below in order to add custon enchantments
//		@Override
...
//		}
		...
		public MerchantRecipe generateRecipe(Random rand) {
			...
			if (input.itemID == Item.bootsLeather.itemID) //wizard boots, featherfalling X
			{
				int enchantmentID = 2;
				...
				result.setItemName("Wizard Boots");
			}
			else if (input.itemID == Item.bootsGold.itemID) //gold boots featherfalling V
			{
				int enchantmentID = 2;
			...
			else if (input.itemID == Item.bootsIron.itemID) //iron boots protection III, Unbreaking II
			{
				int enchantmentID = 0;
			...
			else if (input.itemID == Item.pickaxeDiamond.itemID) //diamond pick efficiency III unbreaking III
			{
				int enchantmentID = 32;
				int enchantmentLevel = 3;
				Map<Integer, Integer> toolEnchantments = new HashMap<Integer, Integer>();
				toolEnchantments.put(enchantmentID, enchantmentLevel);
				//unbreaking
			...
			else if (input.itemID == Item.plateIron.itemID) //iron chestplate thorns III blast III
			{
				int enchantmentID = 7;
				int enchantmentLevel = 3;
				Map<Integer, Integer> toolEnchantments = new HashMap<Integer, Integer>();
			...
			else if (input.itemID == Item.helmetIron.itemID) //iron helm respiration V
			{
				int enchantmentID = 5;
				int enchantmentLevel = 5;
				Map<Integer, Integer> toolEnchantments = new HashMap<Integer, Integer>();
			...
			else if (input.itemID == Item.axeIron.itemID) //axe knockback II fire aspect I
			{
				int enchantmentID = 19;
			...
			else if (input.itemID == Item.swordIron.itemID) //sword smite V
			{
				int enchantmentID = 17;
				int enchantmentLevel = 5;
				Map<Integer, Integer> toolEnchantments = new HashMap<Integer, Integer>();
				toolEnchantments.put(enchantmentID, enchantmentLevel);
			...
			else if (input.itemID == Item.shears.itemID) //shears unbreaking II
			{
				int enchantmentID = 34;
				int enchantmentLevel = 2;
				Map<Integer, Integer> toolEnchantments = new HashMap<Integer, Integer>();
				toolEnchantments.put(enchantmentID, enchantmentLevel);
			...
			else if (input.itemID == Item.swordDiamond.itemID) //diamond sword w/ 2 smite 2 bane
			{
				int enchantmentID = 17;
				int enchantmentLevel = 2;
				Map<Integer, Integer> toolEnchantments = new HashMap<Integer, Integer>();
			...
			else if (input.itemID == Item.axeStone.itemID) //shears knockback IV
			{
				int enchantmentID = 19;
			...
			else if (input.itemID == Item.shovelDiamond.itemID) //diamond shovel efficiency III unbreaking III
			{
				int enchantmentID = 32;
				int enchantmentLevel = 3;
				Map<Integer, Integer> toolEnchantments = new HashMap<Integer, Integer>();
			...
			{
				result = EnchantmentHelper.addRandomEnchantment(rand, input.copy(), 5 + rand.nextInt(15));
			}
			//AARON custom enchanted trades ^ ^ ^ 
...
////			ItemStack result; 
////			
////			if (input.itemID == Item.bootsLeather.itemID)
////			{
////				int enchantmentID = 2;
////				int enchantmentLevel = 3;
////				Map<Integer, Integer> toolEnchantments = new HashMap<Integer, Integer>();
