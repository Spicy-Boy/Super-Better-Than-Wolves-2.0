	...
	implements IInventory
{
    ...
    private void CheckForNauseateNearbyPlayers( FCBlockMillStone block )
    {
    		...
    		worldObj.getTotalWorldTime() % 40L == 0L )
    	{
    		...
    		// AARON fixed the big lie... the processing of netherrack is quite detrimental you know... it has externalities you know..
            EntityCreature.AttemptToPossessCreaturesAroundBlock(worldObj, xCoord, yCoord, zCoord, 1, 15);
    	}
    }
