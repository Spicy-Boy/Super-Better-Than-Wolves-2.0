...
//this class has been adapted (mostly just copied) from PotTX's Mob Enhancements!
//this class gives zombies the power to break certain weak blocks
public class SuperBTWEntityAIBreakBlock extends EntityAIBase 
{
    ...
    public SuperBTWEntityAIBreakBlock(EntityLiving entityLiving) {
            ...
            for (int dy : new int[]{1, 0}) {
                ...
                for (int[] dxz : dxzList) {
                    ...
                    if (this.theEntity.getDistanceSq((double) this.targetPosX + 0.5F, this.theEntity.posY, (double) this.targetPosZ + 0.5F) <= 2.25D
                    	...
                    	//AARON removes tool references because I don't want that to be a factor
...
//                            }
    ...
    //AARON removed references to tools, since I want empty handed zombies to get to work as well
