...
public class SCBlockMelonGrowingWaterAsleep extends SCBlockMelonGrowingAsleep 
{
	
	protected SCBlockMelonGrowingWaterAsleep(int iBlockID, int stemBlock, int vineBlock, int flowerBlock,
...
//		setUnlocalizedName("SCBlockMelonWaterGrowing");
	...
	public void grow(World world, int i, int j, int k, Random random)
	{
		...
		world.setBlockAndMetadataWithNotify(i, j, k, SCDefs.melonWater.blockID ,meta);
	}
