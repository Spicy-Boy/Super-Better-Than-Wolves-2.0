...
{	
    ...
    static
    {
    	...
    	//AARON added flowers and mushrooms to the list!
    	m_bCarriableBlocks[Block.plantRed.blockID] = true;
    	m_bCarriableBlocks[Block.plantYellow.blockID] = true;
    	m_bCarriableBlocks[Block.mushroomRed.blockID] = true;
    	m_bCarriableBlocks[Block.mushroomBrown.blockID] = true;
    }
    ...
    {    	
        ...
        {
        	//AARON adds one extra check here to make picking up stuff illegal unless config says ok (they can still get flowers!)
        	if (!SuperBTW.instance.getIsEndermanGriefingEnabled() && (iBlockID != Block.plantRed.blockID &&
        			iBlockID != Block.plantYellow.blockID &&
        			iBlockID != Block.mushroomRed.blockID &&
