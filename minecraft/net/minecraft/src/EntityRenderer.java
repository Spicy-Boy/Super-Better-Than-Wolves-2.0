    ...
    private void orientCamera(float par1)
    {
        ...
        if (var2.isPlayerSleeping())
        {
            ...
            if (!this.mc.gameSettings.debugCamEnable)
            {
                ...
                //AARON changes this so that sleeping isn't funky directionally speaking. Thanks CE team!
                if (var10 == Block.bed.blockID || var10 == SuperBTWDefinitions.fcBlockBedroll.blockID)
                {
