...
public class GuiChat extends GuiScreen
{
    ...
    //AARON fields for chat toggle
    boolean chatToggled = true;
    ...
    //AARON added these methods to create toggle-able chat when sleeping!
    @Override
    ...
    //:D
    public void setChatToggled(boolean toggle)
    {
    ...
    {
    	//AARON added this toggle here, prevents the chat entry bar from showing up but NOT previous chat messages
