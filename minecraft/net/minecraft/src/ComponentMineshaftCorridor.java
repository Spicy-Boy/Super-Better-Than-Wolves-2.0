...
public class ComponentMineshaftCorridor extends StructureComponent
{
    ...
    //SAU: ADDED
    private static ArrayList<WeightedRandomChestContent> minecartLoot = new ArrayList();
        ...
        else
        {
            ...
            for (var9 = 0; var9 < this.sectionCount; ++var9)
            {
                ...
                */
                ...
                //SAU: ADDED
                int iNumItems = FCAddOnHandler.getNumberOfItemsInMinecartChests(par2Random);
                ...
                if (iNumItems == 0)
                {
                	iNumItems = 3 + par2Random.nextInt(4);
                }
...
//                    this.generateStructureChestContents(par1World, par3StructureBoundingBox, par2Random, 2, 0, var10 - 1, WeightedRandomChestContent.func_92080_a(StructureMineshaftPieces.func_78816_a(), new WeightedRandomChestContent[] {Item.enchantedBook.func_92114_b(par2Random)}), 3 + par2Random.nextInt(4));
                	...
                	this.generateStructureChestContents(par1World, par3StructureBoundingBox, par2Random, 2, 0, var10 - 1, WeightedRandomChestContent.func_92080_a(minecartLoot.toArray(arr), new WeightedRandomChestContent[] {Item.enchantedBook.func_92114_b(par2Random)}), iNumItems);
                }

                if (par2Random.nextInt(100) == 0)
                {
                	//SAU: CHANGED
                    this.generateStructureChestContents(par1World, par3StructureBoundingBox, par2Random, 0, 0, var10 + 1, WeightedRandomChestContent.func_92080_a(minecartLoot.toArray(arr), new WeightedRandomChestContent[] {Item.enchantedBook.func_92114_b(par2Random)}), iNumItems);
//                    this.generateStructureChestContents(par1World, par3StructureBoundingBox, par2Random, 0, 0, var10 + 1, WeightedRandomChestContent.func_92080_a(StructureMineshaftPieces.func_78816_a(), new WeightedRandomChestContent[] {Item.enchantedBook.func_92114_b(par2Random)}), 3 + par2Random.nextInt(4));
    ...
    static {
		...
		//id, item damage, min stack, max stack, weight
...
//		minecartLoot.add(new WeightedRandomChestContent(Item.pumpkinSeeds.itemID, 0, 2, 4, 10) );
    	...
    	FCAddOnHandler.addMinecartLoot( minecartLoot );
    }
    
    private void filterMinecartContents(EntityMinecartChest minecart)
    {
    	FCAddOnHandler.filterMinecartContents(minecart);
    }
    //SAU: END
