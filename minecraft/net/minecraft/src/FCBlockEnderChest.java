    ...
    public boolean onBlockActivated( World world, int i, int j, int k, EntityPlayer player, int iFacing, float fXClick, float fYClick, float fZClick )
    {
    	if ( !world.isRemote )
    	{
        	if ( !world.isBlockNormalCube( i, j + 1, k ) )
        	{
		    	...
		    	//AARON swaps level 1 and level 3 beacon
		    		if ( iAntennaLevel == 0 )
		    		{
		    			// local inventory
		    		...
		    		else if ( iAntennaLevel == 1 )
		    		{
		    			...
		    			//AARON changed the level 1 beacon to be trans-dimensional. 
		    		...
		    		{
		    			//AARON pushed down level 1 -> 2, and level 2->3, and level 3 up to 1!
