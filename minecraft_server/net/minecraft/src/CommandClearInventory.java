...
public class CommandClearInventory extends CommandBase
{
    ...
    {
        EntityPlayerMP var3 = par2ArrayOfStr.length == 0 ? getCommandSenderAsPlayer(par1ICommandSender) : /*AARON changed the method name to findPlayer*/findPlayer(par1ICommandSender, par2ArrayOfStr[0]);
