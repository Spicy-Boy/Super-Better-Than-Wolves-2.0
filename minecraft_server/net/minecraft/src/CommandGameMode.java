...
public class CommandGameMode extends CommandBase
{
    ...
    public void processCommand(ICommandSender par1ICommandSender, String[] par2ArrayOfStr)
    {
        if (par2ArrayOfStr.length > 0)
        {
            ...
            EntityPlayerMP var4 = par2ArrayOfStr.length >= 2 ? /*AARON changed the method name to findPlayer*/findPlayer(par1ICommandSender, par2ArrayOfStr[1]) : getCommandSenderAsPlayer(par1ICommandSender);
