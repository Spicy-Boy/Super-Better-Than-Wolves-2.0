...
public class FCBlockTrapDoor extends BlockTrapDoor
{
    ...
    //AARON added this to make trap doors climbable when facing vertically ::DD
	@Override
	public boolean IsBlockClimbable( World world, int i, int j, int k )
	{
		//if it is above a ladder, that is!
		if (world.getBlockId(i, j-1, k) == FCBetterThanWolves.fcBlockLadder.blockID)
		{
			return true;
		}
