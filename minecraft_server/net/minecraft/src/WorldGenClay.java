                ...
                for (int var9 = par5 - var6; var9 <= par5 + var6; ++var9)
                {
                    ...
                    if (var10 * var10 + var11 * var11 <= var6 * var6)
                    {
                        for (int var12 = par4 - var7; var12 <= par4 + var7; ++var12)
                        {
                            ...
                            {
                            	//AARON made it possible for full blocks of clay to generate in oceans/deep places
                            	if (par4 < 56) //the y level must be lower than the specified int to generate full clay
                            	{
                            		int clayChance = par2Random.nextInt(12);
                            		
                            		if (clayChance < 2)
                            		{
                                        par1World.setBlock(var8, var12, var9, FCBetterThanWolves.fcBlockUnfiredClay.blockID, 0, 0);
                            		}
                            		else
                            		{
