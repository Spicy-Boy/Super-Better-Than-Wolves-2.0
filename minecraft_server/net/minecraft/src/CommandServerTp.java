...
public class CommandServerTp extends CommandBase
{
    ...
    public void processCommand(ICommandSender par1ICommandSender, String[] par2ArrayOfStr)
    {
        ...
        else
        {
            ...
            {
                var3 = /*AARON changed the method name to findPlayer*/findPlayer(par1ICommandSender, par2ArrayOfStr[0]);
            ...
            if (par2ArrayOfStr.length != 3 && par2ArrayOfStr.length != 4)
            {
                ...
                {
                    EntityPlayerMP var11 = findPlayer(par1ICommandSender, par2ArrayOfStr[par2ArrayOfStr.length - 1]);
